...
exports.run = async (client, message, args) => {
 ...
 if(!message.member.roles.cache.some(r => ["789194952025571331"].includes(r.id)));
...
//
  ...
  .setAuthor('Uyarı')
  .setDescription(`**<a:hydratac:789369824249643009> ${kullanıcı} Adlı Kullanıcı \`${sebep}\` Sebebiyle Uyarıldı.**`)
